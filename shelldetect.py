...
class ShellDetector(threading.Thread):
    _extension = ["php", "asp","ashx","aspx","cer","cdx","jpg","jspx","jsp","txt"]
    ...
    def alert(self, _content, _color='', _class='info', _html=True, _flag=True):
        _color_result = {
            'red': '\033[91m',
            'green': '\033[92m',
            'yellow': '\033[93m',
    ...
    def flush(self):
        if self._command_line is False:
            print("Flush")
            filename = time.strftime(self._report_format)
